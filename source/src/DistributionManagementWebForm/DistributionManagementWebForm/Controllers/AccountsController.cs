...
namespace DistributionManagementWebForm.Controllers
{
    public class AccountsController : Controller
    {
        ...
        {
            var accounts = db.Accounts.Include(a => a.Profile);
        ...
        {
            ViewBag.account_id = new SelectList(db.Profiles, "profile_id", "first_name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "account_id,username,password,isActivated,created_date")] Account account)
        {
            ...
            ViewBag.account_id = new SelectList(db.Profiles, "profile_id", "first_name", account.account_id);
            return View(account);
        }
