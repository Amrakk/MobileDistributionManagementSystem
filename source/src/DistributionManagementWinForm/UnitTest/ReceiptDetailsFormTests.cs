...
namespace UnitTest
{
    ...
    public class ReceiptDetailsFormTests
    {
        ...
        [TestMethod]
        public void Product_id_ReturnsWrongId()
        {
            ReceiptDetailsForm form = new ReceiptDetailsForm();
        ...
        public void Received_id_ReturnsMaxReceivedId()
        {
            ...
            int maxID = Convert.ToInt32(Connection.selectQuery("SELECT MAX(received_id) FROM Goods_Received_Note").Rows[0][0].ToString());
